...
What it does: reads player-visible state from the instrumented DOSBox-X runtime, then normalizes it into json object that is readable by ai-agent, thus providing game-agent console line interface.
